#!/usr/bin/env python3
"""
Send verification email manually using SendGrid for autotest@example.com
"""
...
async def send_verification_email():
    """Send verification email to autotest@example.com using SendGrid."""
    
    import os
    api_key = os.getenv('SENDGRID_API_KEY', '')
    email = "autotest@example.com"
    username = "autotest"
    code = "958067"  # The code from the database
