#!/usr/bin/env python3
"""
Send verification email manually using SendGrid for jonathanmaria@gmail.com
"""
...
async def send_verification_email():
    """Send verification email to jonathanmaria@gmail.com using SendGrid."""
    
    import os
    api_key = os.getenv('SENDGRID_API_KEY', '')
    email = "jonathanmaria@gmail.com"
    username = "infoboy27"
    code = "037307"  # The code from the database
