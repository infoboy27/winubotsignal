#!/usr/bin/env python3
"""
Send verification email manually using SendGrid for sendgridtest2@example.com
"""
...
async def send_verification_email():
    """Send verification email to sendgridtest2@example.com using SendGrid."""
    
    import os
    api_key = os.getenv('SENDGRID_API_KEY', '')
    email = "sendgridtest2@example.com"
    username = "sendgridtest2"
    code = "063133"  # The code from the database
